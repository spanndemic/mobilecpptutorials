...
![Xcode C++ Choose Template]({{ site.url }}/images/hello-world-part-1-cplusplus/xcode_cpp_choose_template.png "Xcode C++ Choose Template")

In the next dialog, fill out your app name and organization name, and be sure to select ‘C++’ for the language:

![Xcode C++ Choose Options]({{ site.url }}/images/hello-world-part-1-cplusplus/xcode_cpp_choose_options.png "Xcode C++ Choose Options")
...
![C++ Project Directory]({{ site.url }}/images/hello-world-part-1-cplusplus/cpp_project_directory.png "C++ Project Directory")
...
![Revised C++ Folders]({{ site.url }}/images/hello-world-part-1-cplusplus/revised_cpp_folders.png "Revised C++ Folders")
